 ...
 * 
 * import com.javalab.board.vo.ProductVo; import com.javalab.board.vo.MemberVo;
 * 
 ...
 *//**
	 ...
	 *//*
		 ...
		 * 
		 * @Slf4j // import lombok.extern.slf4j.Slf4j; public class ProductServiceTest {
		 * 
		 * // ProductService 인터페이스 의존성 주입 // 인터페이스 타입으로 의존성 주입했지만 실제로는 그 자식인
		 ...
		 * @Test
		 * 
		 * @Ignore public void testProductService() { assertNotNull(productService);
		 * log.info("productService 인터페이스 : " + productService); //
		 * ProductServiceImpl@7063686f }
		 * 
		 * @Test
		 * 
		 * @Ignore public void testGetProduct() { int bno = 1; BoardVo boardVo =
